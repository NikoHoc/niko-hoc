    ...
    return (
        <section id="contact" className="py-20 flex flex-col items-start gap-8 max-w-7xl mx-auto w-full">
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10 mt-4">
                <div className="lg:col-span-3 bg-neutral-900 border border-neutral-800 rounded-2xl p-6 md:p-8 shadow-lg flex flex-col justify-center">
                ...
                <div className="lg:col-span-2 flex flex-col gap-4 justify-between h-full">
                    ...
                    <div className="group flex flex-col justify-center p-4 sm:p-5 bg-neutral-900 border border-neutral-800 rounded-xl transition-all duration-300 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10">
